...
export class ChampionshipStaffRepository extends BaseRepositoryImpl<ChampionshipStaff> {
  ...
  async findByChampionshipId(championshipId: string): Promise<ChampionshipStaff[]> {
  ...
  async findByUserAndChampionship(userId: string, championshipId: string): Promise<ChampionshipStaff | null> {
  ...
  async getUserStaffChampionships(userId: string): Promise<ChampionshipStaff[]> {
    return this.repository.find({
      where: {
        userId,
        isActive: true
  ...
  async createStaffMember(staffData: Partial<ChampionshipStaff>): Promise<ChampionshipStaff> {
