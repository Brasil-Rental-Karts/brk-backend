 ...
 *     description: Create a new club (available to admins, managers and members)
 *     tags: [Clubs]
 *     security:
 *       - bearerAuth: []
 *     requestBody:
 ...
 *       403:
 *         description: Forbidden - requires admin, manager or member role
 *       500:
 *         description: Internal server error
 *   get:
 *     summary: Get all clubs
 *     description: Retrieve a list of all clubs (available to all authenticated users)
 *     tags: [Clubs]
 *     security:
 *       - bearerAuth: []
 *     responses:
 ...
 *     description: Retrieve a club by ID (available to all authenticated users)
 *     tags: [Clubs]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *   put:
 *     summary: Update club
 *     description: Update a club by ID (admin can update any club, managers can only update clubs they own)
 *     tags: [Clubs]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *         description: Unauthorized
 *       403:
 *         description: Forbidden - requires admin role or ownership by manager
 *       404:
 *         description: Club not found
 *       500:
 *         description: Internal server error
 *   delete:
 *     summary: Delete club
 *     description: Delete a club by ID (admin can delete any club, managers can only delete clubs they own)
 *     tags: [Clubs]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     description: Change the owner of a club (admin only)
 *     tags: [Clubs]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     responses:
 *       200:
 *         description: Club ownership updated successfully
 *       401:
 *         description: Unauthorized
 *       403:
