...
export class PenaltyController extends BaseController {
  ...
  constructor() {
    super('/penalties');
    // Inicializar o service com o repository
    // TODO: Implementar injeção de dependência adequada
    this.penaltyService = new PenaltyService(new PenaltyRepositoryImpl(null as any));
