...
export class RaceTrackController extends BaseController {
  ...
  private async createRaceTrack(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
  ...
  private async getAllRaceTracks(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
  ...
  private async getActiveRaceTracks(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
  ...
  private async getRaceTrackById(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      const { id } = req.params;
  ...
  private async getRaceTrackByName(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
  ...
  private async getRaceTracksByCity(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
  ...
  private async getRaceTracksByState(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
  ...
  private async updateRaceTrack(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      const { id } = req.params;
  ...
  private async deleteRaceTrack(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      const { id } = req.params;
  ...
  private async toggleRaceTrackActive(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      const { id } = req.params;
