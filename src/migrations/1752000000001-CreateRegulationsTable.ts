...
export class CreateRegulationsTable1752000000001 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_Regulations_seasonId" ON "Regulations" ("seasonId")`
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_Regulations_order" ON "Regulations" ("order")`
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_Regulations_isActive" ON "Regulations" ("isActive")`
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_Regulations_seasonId_order" ON "Regulations" ("seasonId", "order")`
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP TRIGGER IF EXISTS regulations_notify_trigger ON "Regulations"`
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "Regulations" DROP CONSTRAINT "FK_Regulations_Seasons_seasonId"`
    );
