...
export class AddAdminPaymentStatuses1757000000000
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TYPE "public"."SeasonRegistrations_paymentstatus_enum" ADD VALUE 'exempt'`
    );
    await queryRunner.query(
      `ALTER TYPE "public"."SeasonRegistrations_paymentstatus_enum" ADD VALUE 'direct_payment'`
    );
  }
