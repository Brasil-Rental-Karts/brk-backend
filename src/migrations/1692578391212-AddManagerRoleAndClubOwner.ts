...
export class AddManagerRoleAndClubOwner1692578391212 implements MigrationInterface {
    name = 'AddManagerRoleAndClubOwner1692578391212'

    public async up(queryRunner: QueryRunner): Promise<void> {
        // Check if the Manager role already exists in the enum
        ...
        // Check if ownerId column exists in Clubs table
        ...
        if (checkColumnQuery.length === 0) {
            // Add ownerId column to Clubs table
