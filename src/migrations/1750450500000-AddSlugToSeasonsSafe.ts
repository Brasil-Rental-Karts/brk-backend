...
export class AddSlugToSeasonsSafe1750450500000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "Seasons" ADD "slug" character varying(100)`
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "Seasons" ADD CONSTRAINT "UQ_seasons_slug" UNIQUE ("slug")`
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "Seasons" DROP CONSTRAINT "UQ_seasons_slug"`
    );
