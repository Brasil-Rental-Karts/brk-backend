...
export class CreateStagesTable0013000000000 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP TRIGGER IF EXISTS stages_notify_trigger ON "Stages"`
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "Stages" DROP CONSTRAINT "FK_Stages_ScoringSystem_defaultScoringSystemId"`
    );
    await queryRunner.query(
      `ALTER TABLE "Stages" DROP CONSTRAINT "FK_Stages_GridTypes_defaultGridTypeId"`
    );
    await queryRunner.query(
