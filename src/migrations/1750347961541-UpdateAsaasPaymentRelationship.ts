...
export class UpdateAsaasPaymentRelationship1750347961541
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "AsaasPayments" ADD "asaasInstallmentId" character varying(100)`
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "AsaasPayments" DROP COLUMN "asaasInstallmentId"`
    );
  }
}
